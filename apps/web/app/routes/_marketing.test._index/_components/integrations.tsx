...
export function IntegrationsFeature() {
  ...
  return (
    <div className="absolute left-4 top-4 h-[300px] w-full border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105">
      <div
