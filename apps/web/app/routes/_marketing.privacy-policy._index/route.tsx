  ...
  return (
    <div>
      ...
      >
        ...
        <p>Effective date: 2024-06-17</p>
        <p>
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b> Tonearm Pty Ltd</b>.
        </p>
        <p>
          <b>Tonearm Pty Ltd</b> (“us”, “we”, or “our”) operates{' '}
          <b>usetonearm.com</b> (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>usetonearm.com</b>, and
        ...
        <p>
          <b>SERVICE</b> means the usetonearm.com website operated by Tonearm
          Pty Ltd.
        </p>
        <p>
        ...
        <p>Tonearm Pty Ltd uses the collected data for various purposes:</p>
        ...
        <p>
          Tonearm Pty Ltd will take all the steps reasonably necessary to ensure
        ...
        <p>
          ...
          us at <b>support@usetonearm.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>support@usetonearm.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>support@usetonearm.com</b>.
        </p>
      </div>
    </div>
  );
